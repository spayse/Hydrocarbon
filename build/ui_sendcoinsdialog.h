...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 C8H"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 C8H"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 C8H"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 C8H"));
        ...
        labelBalance->setText(QStringLiteral("123.456 C8H"));
